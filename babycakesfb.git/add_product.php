...
//exit();
 ?>
<?php 
	require_once('Classes/header_class.php'); 
	$ThisPage = new base_page();
	if($ThisPage->base_page())
		echo "header_class OK!!!.";
		$ThisPage->validate_user();
	//exit(0);
?>
...
<div class="container">
  ...
  <div class="content">
   <form action="../baby-bin/products.php" method="post" name="form1" id="form1" >
  <table align="center">
    
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Product_name:</td>
      <td>Blue Babycake
        <input type="text" name="product_name" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Price:</td>
      <td>50.00
        <input type="text" name="price" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Details:</td>
      <td>Blue Cake
        <input type="text" name="details" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Category:</td>
      <td>Cakes
        <input type="text" name="category" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Subcategory:</td>
      <td>Boys
        <input type="text" name="subcategory" value="" size="32" /></td>
    </tr>
      <tr valign="baseline">
